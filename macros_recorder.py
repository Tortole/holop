...
class MacrosRecorder:
    ...
    def _to_relative_coord(x, y):
        ...
        resolution = MacrosRecorder._get_resolution()
    ...
    def to_json(self):
        ...
        def convert(m):
            ...
            if 'x' in m and 'y' in m:
                m['x'], m['y'] = MacrosRecorder._to_relative_coord(m['x'], m['y'])
            return m
    ...
    def from_json(self, json_str):
        ...
        def convert(m):
            ...
            if 'x' in m and 'y' in m:
                m['x'], m['y'] = MacrosRecorder._to_absolute_coord(m['x'], m['y'])
            return m

        for m in json.loads(json_str):
            self.macro.append(convert(m))
